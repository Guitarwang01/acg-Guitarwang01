  ...
  for (unsigned int iw = 0; iw < img_width; ++iw) {
    for (unsigned int ih = 0; ih < img_height; ++ih) {
      ...
      for (int isample = 0; isample < nsample; ++isample) {
        ...
        float rad = hit0_brdf*hit0_refl.dot(hit0_normal)*hit1_rad/hit0_pdf/nsample; // replace this with some code
      ...
      for (int isample = 0; isample < num_half_sample; ++isample) {
        ...
        float rad = hit0_brdf*hit0_refl.dot(hit0_normal)*hit1_rad*(hit0_pdf_light_sample/(hit0_pdf_brdf_sample+hit0_pdf_light_sample))/hit0_pdf_light_sample/num_half_sample; // write some code
        // float rad = hit0_brdf*hit1_rad/(hit0_pdf_brdf_sample+hit0_pdf_light_sample)/num_half_sample;
      ...
      for (int isample = 0; isample < nsample / 2; ++isample) {
        ...
        float hit0_pdf_light_sample = pdf_light_sample(hit0_normal, hit0_pos, cam_ray_dir, hit0_refl, hit0_object);
        float hit0_pdf_brdf_sample = spheres[hit0_object].pdf(hit0_normal, cam_ray_dir, hit0_refl);
        float rad = hit0_brdf*hit0_refl.dot(hit0_normal)*hit1_rad*(hit0_pdf_brdf_sample/(hit0_pdf_brdf_sample+hit0_pdf_light_sample))/hit0_pdf_brdf_sample/num_half_sample; // write some code
        // float rad = hit0_brdf*hit1_rad/(hit0_pdf_brdf_sample+hit0_pdf_light_sample)/num_half_sample;
        img_mis[ih * img_width + iw] += rad;
      }
    }
